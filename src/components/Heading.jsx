...
function Heading({className, category}) {
  ...
  return (
      ...
      <div className="container">
        <Typography variant="h3" className='font-calistoga text-gray-800 dark:text-gray-300 tracking-wider transition-colors duration-300'>{category === 'Home' ? 'My Day' : category}</Typography>
        <p
